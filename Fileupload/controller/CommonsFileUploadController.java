...
public class CommonsFileUploadController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("/commons/fileupload POST - 확인!");
		
		// application/x-www-form-urlencoded 인코딩 방식으로 전달된
		//요청파라미터는 req.getParameter() 메소드를 통해서 얻을 수 있지만
		
		// multipart/form-data 인코딩 방식으로 전달된
		//요청파라미터는 req.getParameter()메소드에서 null 만 반환된다
//		
		...
		System.out.println("file : " + req.getParameter("upfile"));
		
		
		// 서비스 객첼ㄹ 이용한 파일 업로드 처리
